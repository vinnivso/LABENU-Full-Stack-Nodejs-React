...
export default function ApplicationFormPage() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://us-central1-labenu-apis.cloudfunctions.net/labeX/vinicius-oliveira-lovelace/trips"
      )
      .then((res) => {
  ...
  const onSubmitApplicationForm = (e) => {
    ...
    axios.post(
      `https://us-central1-labenu-apis.cloudfunctions.net/labeX/vinicius-oliveira-lovelace/trips/${form.trip.id}/apply`,
      body
    );
  };
  ...
  return (
    <div>
      ...
      <StyledApplicationFormPageForm onSubmit={onSubmitApplicationForm}>
        <TextField
          helperText={"Please insert your name"}
          label={"Name"}
          name={"name"}
          value={form.name}
          onChange={(e) =>
        ...
        />
        <TextField
          helperText={"Please insert your motivation to partipate in this trip"}
        ...
        />
        <TextField
          helperText={"Please insert your profession"}
          label={"Profession"}
          name={"profession"}
